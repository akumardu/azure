...
namespace RelayListener
{
...

    {
        ...
        private const string RelayNamespace = "testrelayamar.servicebus.windows.net";

        private const string ConnectionName = "testhybrid";

        private const string KeyName = "RootManageSharedAccessKey";

        private const string Key = "1duvGbc8tUq2jGlWMbbEOY/s+aDj8KZeiCq9y6u0PTA=";
...

        {
            ...
            var listener = new HybridConnectionListener(
                                        new Uri(string.Format("sb://{0}/{1}", RelayNamespace, ConnectionName)), tokenProvider);
